...
*Create barchart for hospital_count_dataset --- used as illustration of dataset
```{r}
#load the dataset
...
*Create barchart for hospoital count in county -republican vs. democratic
```{r}
...
*Create barchart for voting_age dataset--- used as illustration of dataset
```{r}
#load the dataset
...
*Create barchart for voting_age_distribution -republican vs. democratic
```{r}
