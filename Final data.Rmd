...
# Create the bar chart
ggplot(poverty_county_level_results, aes(x = reorder(result, below_poverty_percentage), y = below_poverty_percentage, fill = result)) +
  geom_bar(stat = "identity", color = "black") +
  scale_fill_manual(values = c("democratic" = "blue", "republic" = "red")) +
...
>>>>>>> 6e210a51a6a7f32cd6011c9487b79e41b71253a5
